    	...
    	<div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				while($projects_query->have_posts()): $projects_query->the_post();
					...
					?>
						<li <?php if(isset($blank[0])&&$blank[0]=='Yes'){ ?> class="blank" <?php  } ?> class="<?php echo str_replace(':','',str_replace(')','',str_replace('(','',str_replace(' ','_',strtolower(get_the_title())))));?>">
							<?php 
								if(isset($blank[0])&&$blank[0]=='Yes'){
							?>
									<a data-gall="works" data-overlay="rgba(255,255,255,1)"  title="Project Name" href="#">
